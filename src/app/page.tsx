...
const DefibInterface: React.FC = () => {
  ...
  const renderScreenContent = () => {
    switch (displayMode) {
      case "ARRET":
        return (
          <div className="absolute inset-3 bg-black rounded-lg flex items-center justify-center"></div>
        );
      case "DAE":
        return (
          <div className="absolute inset-3 bg-black rounded-lg flex items-center justify-center">
